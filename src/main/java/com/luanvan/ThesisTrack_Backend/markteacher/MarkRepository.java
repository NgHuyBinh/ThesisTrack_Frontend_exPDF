...
public interface MarkRepository extends JpaRepository<Mark, Integer> {
    ...
    // boolean existsByStudentIdAndTeacherIdAndSemesterIdIgnoreCase(String string,
    // String string2, String string3);

    // List<Mark> findByTeacherIdAndStudentIdAndSemesterId(Integer studentId,
    ...
    List<Mark> findByStudentIdAndTeacherId(Integer studentId, Integer teacherId);
}